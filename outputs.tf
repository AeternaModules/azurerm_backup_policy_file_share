...
output "backup_policy_file_shares_backup" {
  ...
  value       = { for k, v in azurerm_backup_policy_file_share.backup_policy_file_shares : k => one(v.backup) if v.backup != null && length(v.backup) > 0 }
}
...
output "backup_policy_file_shares_retention_daily" {
  ...
  value       = { for k, v in azurerm_backup_policy_file_share.backup_policy_file_shares : k => one(v.retention_daily) if v.retention_daily != null && length(v.retention_daily) > 0 }
}
output "backup_policy_file_shares_retention_monthly" {
  ...
  value       = { for k, v in azurerm_backup_policy_file_share.backup_policy_file_shares : k => one(v.retention_monthly) if v.retention_monthly != null && length(v.retention_monthly) > 0 }
}
output "backup_policy_file_shares_retention_weekly" {
  ...
  value       = { for k, v in azurerm_backup_policy_file_share.backup_policy_file_shares : k => one(v.retention_weekly) if v.retention_weekly != null && length(v.retention_weekly) > 0 }
}
output "backup_policy_file_shares_retention_yearly" {
  ...
  value       = { for k, v in azurerm_backup_policy_file_share.backup_policy_file_shares : k => one(v.retention_yearly) if v.retention_yearly != null && length(v.retention_yearly) > 0 }
}
